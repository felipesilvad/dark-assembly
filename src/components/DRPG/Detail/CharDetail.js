...
const CharDetail = ({match}) => {
  ...
  return (
    <Container className="p-0">
      <div className="p-0 m-0 d-none-max-m">
        <Row>
          <Col sm={3} className="p-1 pt-3">
            <Image src={char.main_url} className="portrait-img rounded mx-auto d-block" />
            <div className="gray-bg mt-2">
              <Row className="m-0 border-b">
                <Col xs={5} className="p-1 border-r">Type</Col>
                <Col xs={7} className="d-flex p-1">
                  {!! char.type &&(
                    <Image src={require(`../../../assets/DRPG/icons/${char.type}.png`)} className="type_icons-d" />
                  )}
                  <h4 className="type-txt">{char.type}</h4>
                </Col>
              </Row>
              <Row className="m-0 border-b">
                <Col xs={5} className="p-1 border-r">Forte</Col>
                <Col xs={7} className="d-flex p-1">
                  {!! char.forte &&(
                    <Image src={require(`../../../assets/DRPG/icons/weapons/${char.forte}.png`)} className="type_icons-d" />
                  )}
                  <h4 className="type-txt">{char.forte}</h4>
                </Col>
              </Row>
              <Row className="m-0 border-b">
                <Col xs={5} className="p-1 border-r">Gender</Col>
                <Col xs={7} className="d-flex p-1">
                  {!! char.gender &&(
                    <Image src={require(`../../../assets/DRPG/icons/${char.gender}.png`)} className="type_icons-d" />
                  )}
                  <h4 className="type-txt">{char.gender}</h4>
                </Col>
              </Row>
              <h4 className="type-txt">{char.type_2}</h4>
            </div>
              ...
              <div className="gray-bg" >
                {!!char.class_1 && (
                  <div className="border-b">
                    <Row>
                      <Col xs={2} className="text-right border-r p-0">1<Image src={star} className="star-class" /></Col>
                ...
                {!!char.class_2 && (
                  <div className="border-b">
                    <Row>
                      <Col xs={2} className="text-right border-r p-0">2<Image src={star} className="star-class" /></Col>
                ...
                {!!char.class_3 && (
                  <div className="border-b">
                    <Row>
                      <Col xs={2} className="text-right border-r p-0">3<Image src={star} className="star-class" /></Col>
                ...
                {!!char.class_4 && (
                  <div className="border-b">
                    <Row>
                      <Col xs={2} className="text-right border-r p-0">4<Image src={star} className="star-class" /></Col>
                ...
                {!!char.class_5 && (
                  <div className="border-b">
                    <Row>
                      <Col xs={2} className="text-right border-r p-0">5<Image src={star} className="star-class" /></Col>
                ...
                {!!char.class_6 && (
                  <div className="">
                    <Row>
                      <Col xs={2} className="text-right border-r p-0">6<Image src={star} className="star-class" /></Col>
          ...
          <Tabs className="d-flex justify-content-between" defaultActiveKey="unique">
            <Tab className="skill-tab" eventKey="unique" title="Unique Skills">
              <Table striped bordered className="gray-bg">
                ...
                {!! char.uniqueSkills &&(char.uniqueSkills.map((skill) => (
                  <CharDetailSkillD id={skill.value} type={char.type}/>
                )))}
              </Table>
            </Tab>
            <Tab className="skill-tab" eventKey="spells" title="Spells">
              <Table striped bordered className="gray-bg">
                ...
                {!! char.spell4 &&(
                  <CharDetailSkillD id={char.spell4.value} type={char.type} wmlv={4} />
                )}
                {!! char.spell9 &&(
                ...
                <Tabs className="d-flex justify-content-between" defaultActiveKey="Sword">
                  <Tab className="skill-tab" eventKey="Sword" title={<Image src={Sword} className="w_icons" />}>
                    <Table striped bordered className="gray-bg">
                      ...
                      {wmSkills.map((skill) => (
                        (skill.weapon === "Sword") ? (<CharDetailSkillD id={skill.id} type={char.type} />) : ('')
                      ))}
                    </Table>
                  </Tab>
                  <Tab className="skill-tab" eventKey="Fist" title={<Image src={Fist} className="w_icons" />}>
                    <Table striped bordered className="gray-bg">
                        ...
                        {wmSkills.map((skill) => (
                          (skill.weapon === "Fist") ? (<CharDetailSkillD id={skill.id} type={char.type} />) : ('')
                        ))}
                      </Table>
                  </Tab>
                  <Tab className="skill-tab" eventKey="Spear" title={<Image src={Spear} className="w_icons" />}>
                    <Table striped bordered className="gray-bg">
                      ...
                      {wmSkills.map((skill) => (
                        (skill.weapon === "Spear") ? (<CharDetailSkillD id={skill.id} type={char.type} />) : ('')
                      ))}
                    </Table>
                  </Tab>
                  <Tab className="skill-tab" eventKey="Bow" title={<Image src={Bow} className="w_icons" />}>
                    <Table striped bordered className="gray-bg">
                      ...
                      {wmSkills.map((skill) => (
                        (skill.weapon === "Bow") ? (<CharDetailSkillD id={skill.id} type={char.type} />) : ('')
                      ))}
                    </Table>
                  </Tab>
                  <Tab className="skill-tab" eventKey="Gun" title={<Image src={Gun} className="w_icons" />}>
                    <Table striped bordered className="gray-bg">
                      ...
                      {wmSkills.map((skill) => (
                        (skill.weapon === "Gun") ? (<CharDetailSkillD id={skill.id} type={char.type} />) : ('')
                      ))}
                    </Table>
                  </Tab>
                  <Tab className="skill-tab" eventKey="Axe" title={<Image src={Axe} className="w_icons" />}>
                    <Table striped bordered className="gray-bg">
                      ...
                      {wmSkills.map((skill) => (
                        (skill.weapon === "Axe") ? (<CharDetailSkillD id={skill.id} type={char.type} />) : ('')
                      ))}
                    </Table>
                  </Tab>
                </Tabs>
          ...
          <Col md={5}>
            <div className=" pt-3">
              <Row>
                ...
                <Col xs={4}>
                  <Image src={char.portrait_url} className="img-fluid full-img mx-auto d-block gray-bg" />
                  <Image src={char.cut_in_url} className="img-fluid full-img mx-auto d-block gray-bg" />
                </Col>
              </Row>
              <div className="gray-bg" >
                <div className="">
      ...
      <div className="p-0 m-0 d-none-min-m">
        <Row>
          <Col xs={3} className="p-1 pt-3">
            <Image src={char.cut_in_url} className="cut-in-img" />
          </Col>
